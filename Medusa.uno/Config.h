...
public:
    ...
    struct Visuals {
        ...
        ColorToggleThickness GPtrail;
        ColorToggle GPcolision{ false, 1.0f,.0f, .0f, 1.0f };
        ColorToggle GPground{ true, 0.895f, 0.209f, 0.642f, 0.216f };
    ...
    struct Misc {
        ...
        bool fakewalk{ false };
        KeyBind fakeWalkKey{ std::string("Fake Walk") };
        bool edgeJump{ false };
